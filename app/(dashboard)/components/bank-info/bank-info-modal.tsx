...
const BankInfoModal = ({isOpen, onClose, bank, onSuccess}: TBankInfoModalProps) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            console.error(isEditMode ? "Failed tp update bank info" : "Failed to create bank info", error );
            toast.error(isEditMode ? "Failed tp update bank info" : "Failed to create bank info");
        } finally {
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                    <div className="flex flex-col gap-4 w-full">
                        ...
                        <div className="input-group-admin">
                            ...
                            <input type="text" id="accountNumber" name="accountNumber" placeholder="e. g. 2194862362011" value={formData.accountNumber} onChange={handleChange} />
                        </div>
                        <div className="input-group-admin">
                            <label htmlFor="accountName">Account Name / Holder</label><br></br>
                ...
                <Button className="ml-auto mt-3 rounded-lg" type="submit" onClick={handleSubmit} disabled={isSubmitting}>{isEditMode ? "Update Bank Info" : "Create Bank Info"}</Button>
            </form>
        </Modal>
    );
};
