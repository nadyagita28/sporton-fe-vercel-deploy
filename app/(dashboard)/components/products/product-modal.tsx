        ...
        <Modal isOpen={isOpen} onClose={onClose} title={isEditMode ? "Edit Product":"Add New Product"}>
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-4 w-full">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="input-group-admin">
                                ...
                                <input type="number" id="price" name="price" placeholder="e. g. 500000" value={formData.price} onChange={handleChange} />
                            </div>
                            <div className="input-group-admin">
                                <label htmlFor="stock">Stock</label>
                                <input type="number" id="stock" name="stock" placeholder="e. g. 100" value={formData.stock} onChange={handleChange} />
                            </div>
                        </div>
                        <div className="input-group-admin">
                ...
                <div className="input-group-admin">
                    ...
                    <textarea name="description" id="description" rows={7} placeholder="Product Details" value={formData.description} onChange={handleChange}></textarea>
                </div>
                <Button className="ml-auto mt-3 rounded-lg" onClick={handleSubmit} disabled={isSubmitting} type="submit">{isEditMode ? "Update Product" : "Create Product"}</Button>
            </form>
        </Modal>
    );
};
