...
import ProductionActions from "../../components/product-detail/product-actions";
    ...
    return (
        <main className="container mx-auto py-40 flex gap-12">
            <div className="bg-primary-light aspect-square min-w-140 flex justify-center items-center">
                <Image src="/images/products/product-4.png" width={550} height={550} alt="product 4 images" className="aspect-square object-contain w-full" />
            </div>
            <div className="w-full py-7">
                <h1 className="font-bold text-5xl mb-6">
                    SporstOn HyperSoccer v2
                </h1>
